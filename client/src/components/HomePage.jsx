        ...
        <section className="faq-section scroll-reveal">
          ...
          <div className="faq-grid">
            ...
            <FaqItem 
              ...
              answer="The core Amortization Engine and Strategy Sandbox are completely free. I built this platform to democratize the financial mathematics that banks use to maximize profits, putting the power of debt-reduction back in your hands."
