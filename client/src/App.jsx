        ...
        <div className="site-header-inner">
          ...
          <div className="desktop-nav">
            ...
            <div className="site-header-user">
              ...
              <button type="button" className="secondary-btn site-header-logout" style={{background:'red', color:'white',borderColor:'red', height:'30.8px'}} onClick={handleLogout}>
                Log out
              </button>
            </div>
          </div>
